...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnPolylineClickListener {
    ...
    private final int GPS_RESULT_CODE = 0001;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_feedback:
                        ...
                        AlertDialog.Builder feed = new AlertDialog.Builder(MapsActivity.this);
    ...
    private void bottomNav() {
            navigationView2 = findViewById(R.id.bottom_navigation);
            navigationView2.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
                ...
                public boolean onNavigationItemSelected(@NonNull @NotNull MenuItem item) {
                    switch (item.getItemId()) {
                        ...
                        case R.id.nav_bike:
                            calculateDirectionsBike(marker);
                            overridePendingTransition(0, 0);
                            return true;

                        case R.id.nav_transit:
                            calculateDirectionsTransit(marker);
                            overridePendingTransition(0, 0);
                            return true;

                        case R.id.nav_walk:
                            calculateDirectionsWalk(marker);
                            overridePendingTransition(0, 0);
                            return true;
                    }
                    return false;
        ...
        directions.destination(destination).setCallback(new PendingResult.Callback<DirectionsResult>() {
            ...
            public void onFailure(Throwable e) {
                ...
                new Handler(Looper.getMainLooper()).post(new Runnable() {
                    @Override
                    public void run() {
                        Toast toast = Toast.makeText(MapsActivity.this, "No Route for Car", Toast.LENGTH_SHORT);
                        toast.show();
                    }
                });
            }
    ...
    private void calculateDirectionsBike(Marker marker){
        Log.d(TAG, "calculateDirections: calculating directions.");
        ...
        directions.destination(destination).setCallback(new PendingResult.Callback<DirectionsResult>() {
            ...
            public void onFailure(Throwable e) {
                ...
                new Handler(Looper.getMainLooper()).post(new Runnable() {
                    @Override
                    public void run() {
                        Toast toast = Toast.makeText(MapsActivity.this, "No Route for Bicycle", Toast.LENGTH_SHORT);
                        toast.show();
                    }
                });
            }
    ...
    private void calculateDirectionsTransit(Marker marker){
        Log.d(TAG, "calculateDirections: calculating directions.");
        ...
        directions.destination(destination).setCallback(new PendingResult.Callback<DirectionsResult>() {
            ...
            public void onFailure(Throwable e) {
                ...
                new Handler(Looper.getMainLooper()).post(new Runnable() {
                    @Override
                    public void run() {
                        Toast toast = Toast.makeText(MapsActivity.this, "No Route for Transit", Toast.LENGTH_SHORT);
                        toast.show();
                    }
                });
    ...
    private void calculateDirectionsWalk(Marker marker){
        Log.d(TAG, "calculateDirections: calculating directions.");
        ...
        directions.destination(destination).setCallback(new PendingResult.Callback<DirectionsResult>() {
            ...
            public void onFailure(Throwable e) {
                ...
                new Handler(Looper.getMainLooper()).post(new Runnable() {
                    @Override
                    public void run() {
                        Toast toast = Toast.makeText(MapsActivity.this, "No Route for Walking", Toast.LENGTH_SHORT);
                        toast.show();
                    }
                });
